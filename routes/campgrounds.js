...
router.get("/:id/edit", verifyCampgroundOwnership, function(req, res) {
...
router.put("/:id", verifyCampgroundOwnership, function(req, res) {
...
router.delete("/:id", verifyCampgroundOwnership, function(req, res) {
